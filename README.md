...
<body>
    ...
    <div class="container">
        ...
        <!-- Reveal Button -->
        <button class="reveal-btn" onclick="revealMessage()">💖 Click to Reveal My Special Message 💖</button>

        <!-- Hidden Message -->
        <div class="hidden-message" id="hiddenMessage">
            those who click on special msg they need to bring a  chocolate tomorrow  ✨ - Likith Sai
        </div>
    </div>
